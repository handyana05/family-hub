                  ...
                  {week.days.map((day) => (
                    <Link
                      ...
                      className={`block min-h-40 p-3 transition ${
                        ...
                        day.isSelected
                          ? "bg-amber-50 ring-2 ring-amber-400 ring-inset dark:bg-white/10"
                    ...
                    >
                      <div>
                        ...
                        <p className="mt-1 text-base text-slate-500 dark:text-slate-300">
                          {todo.dueAt
                            ? format(todo.dueAt, "HH:mm")
                            : "No time"}
                        </p>
                      </div>

                      <form
                        action={completeTodoFromWallAction}
                      >
                        <input
                          type="hidden"
                          name="todoId"
            ...
            {shoppingItems.length === 0 ? (
              ...
              shoppingItems.map((item) => (
                ...
                >
                  ...
                  <form
                    action={completeShoppingFromWallAction}
                  >
                    <input
                      type="hidden"
                      name="itemId"
